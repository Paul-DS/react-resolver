  ...
  computeState(thisProps, nextState) {
    ...
    Object.keys(resolve).forEach(name => {
      ...
      if (!nextState.resolved.hasOwnProperty(name)) {
        ...
        const isPromise = value instanceof Promise || (typeof value === "object" && value !== null || typeof value === "function") && typeof value.then === "function";
...
Resolver.resolve = function (render, initialData = {}) {
  ...
  renderToStaticMarkup(React.createElement(
    Resolver,
    { data: initialData, onResolve: promise => {
        queue.push(promise);
  ...
  return Promise.all(queue).then(results => {
    const data = _extends({}, initialData);
